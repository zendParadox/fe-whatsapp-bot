            ...
            <CardContent className="pt-10 pb-10 flex flex-col items-center text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Feedback Anda sangat berharga bagi kami. Kami akan meninjau
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-lg">
              Bantu kami membuat GoTEK lebih baik. Laporkan bug, berikan saran
              fitur, atau sekadar menyapa!
            </p>
          </div>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm shadow-xl">
            <CardHeader>
              ...
              <CardDescription>
                Identitas Anda bersifat opsional jika ingin mengirim secara
                anonim.
              </CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="SUGGESTION">
                              💡 Saran Fitur (Suggestion)
                            </SelectItem>
                            <SelectItem value="BUG">
                              🐛 Lapor Bug (Bug Report)
                            </SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Jelaskan sedetail mungkin agar kami dapat memahaminya
                          dengan baik.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
